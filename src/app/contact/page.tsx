            ...
            <div style={{ maxWidth: "900px", margin: "0 auto" }}>
              ...
              >
                ...
                >
                  ...
                  <p className="body-style1-300" style={{ color: "var(--color-core-white)", opacity: 0.9, marginBottom: "var(--dimension-200)" }}>
                    Restez informé de nos actualités, expositions et événements
                  </p>
                  <div style={{ display: "flex", gap: "var(--dimension-300)", flexWrap: "wrap" }}>
                    <a
                    ...
                    >
                      <span className="button__content">Facebook</span>
                    </a>
                    <a
                      ...
                      className="button button--secondary button--200"
                    >
                      <span className="button__content">Instagram</span>
                    </a>
                  </div>
                </div>
